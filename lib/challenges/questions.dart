...
Map<String, List<QuizQuestion>> questionsMap = {
  ...
  'C++_Level 1': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To output data to the console', isCorrect: false),
        AnswerChoice(
            text: 'B. To read input from the console', isCorrect: true),
        AnswerChoice(
            text: 'C. To perform mathematical calculations', isCorrect: false),
        AnswerChoice(text: 'D. To declare variables', isCorrect: false),
      ],
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To subtract 1 from a variable', isCorrect: false),
    ...
    QuizQuestion(
      questionText:
          'Which header file is used for input/output operations in C++?',
      answerChoices: [
  ...
  'C++_Level 2': [
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To declare a variable as constant', isCorrect: true),
        AnswerChoice(
            text: 'B. To specify the accessibility of a variable',
            isCorrect: false),
        AnswerChoice(
            text: 'C. To declare a variable as static', isCorrect: false),
        AnswerChoice(
            text: 'D. To allocate memory for a variable', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To return the memory size of a variable or data type',
            isCorrect: true),
        AnswerChoice(
            text: 'B. To perform arithmetic operations', isCorrect: false),
        AnswerChoice(
            text: 'C. To allocate memory for a variable', isCorrect: false),
        AnswerChoice(
            text: 'D. To declare a variable as static', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To exit a loop or switch statement', isCorrect: false),
        AnswerChoice(
            text:
                'B. To skip the rest of the code in the current iteration and continue to the next iteration of a loop',
            isCorrect: true),
        AnswerChoice(
            text: 'C. To jump to a specific label in the code',
            isCorrect: false),
        AnswerChoice(
            text: 'D. To return a value from a function', isCorrect: false),
      ],
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To insert a new line character', isCorrect: true),
  ...
  'C++_Level 3': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'D. Output stream insertion operator', isCorrect: true),
      ],
    ),
    QuizQuestion(
      questionText: 'What is the output of the following C++ code?'
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To allocate memory for variables', isCorrect: true),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To declare a constant variable', isCorrect: true),
        AnswerChoice(
            text: 'B. To specify the accessibility of a variable',
            isCorrect: false),
        AnswerChoice(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Address of x: (some memory address)', isCorrect: true),
  ...
  'C++_Level 4': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text:
                'B. To skip the rest of the loop body and jump to the next iteration',
            isCorrect: true),
        AnswerChoice(
            text: 'C. To return a value from a function', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            ...
            isCorrect: true),
        AnswerChoice(
            text: 'C. To execute a block of code exactly once',
            isCorrect: false),
        AnswerChoice(
            text: 'D. To execute a block of code based on a condition',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. Message printed 1 times\nMessage printed 2 times\nMessage printed 3 times',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. Message printed 1 times\nMessage printed 1 times\nMessage printed 1 times',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. Message printed 3 times\nMessage printed 2 times\nMessage printed 1 times',
            isCorrect: false),
        AnswerChoice(text: 'D. Error: syntax error', isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To specify the accessibility of a variable or function',
            isCorrect: false),
        AnswerChoice(
            text: 'B. To declare a variable or function as constant',
            isCorrect: false),
        AnswerChoice(
            text: 'C. To allocate memory for a variable', isCorrect: false),
        AnswerChoice(
            text: 'D. To persist the value of a variable across function calls',
            isCorrect: true),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To initialize a pointer variable to zero',
            isCorrect: true),
        AnswerChoice(text: 'B. To declare a null pointer', isCorrect: false),
        AnswerChoice(
            text: 'C. To allocate memory for a pointer', isCorrect: false),
        AnswerChoice(
            text: 'D. To access the memory address of a variable',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Address of x: (some memory address)\nValue of ptr: 0',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. Address of x: (some memory address)\nValue of ptr: (some memory address)',
            isCorrect: false),
        AnswerChoice(text: 'C. Error: syntax error', isCorrect: false),
        AnswerChoice(text: 'D. Error: undefined behavior', isCorrect: false),
      ],
  ...
  'C++_Level 5': [
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. A function that cannot capture variables from its enclosing scope',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. A function that can be defined inline without a separate declaration',
            isCorrect: true),
        AnswerChoice(
            text: 'C. A function that returns a lambda expression',
            isCorrect: false),
        AnswerChoice(
            text: 'D. A function that accepts lambda expressions as arguments',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To copy the contents of one object to another',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. To move the contents of one object to another, leaving the source object in a valid but unspecified state',
            isCorrect: true),
        AnswerChoice(text: 'C. To delete an object', isCorrect: false),
        AnswerChoice(
            text: 'D. To initialize an object with a specific value',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. A pointer that can only point to dynamically allocated memory',
            isCorrect: false),
        AnswerChoice(
            text: 'B. A pointer that automatically manages memory deallocation',
            isCorrect: true),
        AnswerChoice(
            text: 'C. A pointer that points to a function', isCorrect: false),
        AnswerChoice(
            text: 'D. A pointer that cannot be dereferenced', isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText:
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. A programming paradigm that emphasizes manual memory management',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. A design pattern where resource allocation and deallocation are tied to object lifetime',
            isCorrect: true),
        AnswerChoice(
            text: 'C. A way to implement recursion in C++', isCorrect: false),
        AnswerChoice(
            text: 'D. A method for optimizing compile-time performance',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To specify that a function cannot be overridden in derived classes',
            isCorrect: false),
        AnswerChoice(
            text: 'B. To declare a function as a pure virtual function',
            isCorrect: false),
        AnswerChoice(
            text:
        ...
        AnswerChoice(
            text:
                'D. To specify that a function is implemented in the base class',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. Inheriting from multiple classes that share a common base class',
            isCorrect: false),
        AnswerChoice(
            text: 'B. Inheriting from multiple base classes directly',
            isCorrect: true),
        AnswerChoice(
            text: 'C. Inheriting from a class and an interface',
            isCorrect: false),
        AnswerChoice(
            text: 'D. Inheriting from a class and a struct', isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text:
                'C. Defining multiple functions with the same name and parameter list but different return types',
            isCorrect: false),
        AnswerChoice(
            text: 'D. Defining a function inside another function',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. std::vector is a dynamic array with automatic resizing, while std::array is a fixed-size array',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. std::vector is a fixed-size array, while std::array is a dynamic array with automatic resizing',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. std::vector and std::array are interchangeable and can be used interchangeably',
            isCorrect: false),
        AnswerChoice(
            text: 'D. std::vector and std::array are the same thing',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To declare a function as a constant expression',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. To specify that a variable or function can be evaluated at compile time',
            isCorrect: true),
        AnswerChoice(
            text: 'C. To declare a constant variable', isCorrect: false),
        AnswerChoice(
            text: 'D. To indicate that a function does not return a value',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To create and manage threads of execution',
            isCorrect: true),
        AnswerChoice(
            text: 'B. To manage file input and output operations',
            isCorrect: false),
        AnswerChoice(
            text: 'C. To perform mathematical calculations', isCorrect: false),
  ...
  'C#_Level 1': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'C. Performs mathematical calculations', isCorrect: false),
    ...
    QuizQuestion(
      questionText:
          'What is the correct way to define a string variable in C#?',
      answerChoices: [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(text: 'A. To exit a loop', isCorrect: false),
        AnswerChoice(
            text: 'B. To exit a method and optionally return a value',
            isCorrect: true),
        AnswerChoice(
            text: 'C. To print output to the console', isCorrect: false),
  ...
  'C#_Level 2': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. array<int> arr = new array<int>[5];', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To specify the accessibility of a member',
            isCorrect: false),
        AnswerChoice(
            text: 'B. To define a variable number of arguments in a method',
            isCorrect: true),
        AnswerChoice(
            text: 'C. To specify that a method does not return a value',
            isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To specify that a variable cannot be modified',
            isCorrect: false),
        ...
        AnswerChoice(
            text:
                'D. To specify that a member belongs to the class rather than an instance of the class',
            isCorrect: true),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'B. To allocate memory for an object', isCorrect: true),
        AnswerChoice(
            text: 'C. To perform mathematical calculations', isCorrect: false),
        AnswerChoice(
            text: 'D. To specify a method as a constructor', isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            ...
            isCorrect: false),
        AnswerChoice(
            text: 'B. To iterate over elements in an array or collection',
            isCorrect: true),
        AnswerChoice(
            text: 'C. To execute a block of code based on a condition',
            isCorrect: false),
  ...
  'C#_Level 3': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'C. Allocates memory for an object', isCorrect: false),
        AnswerChoice(
            text: 'D. Executes a block of code repeatedly', isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To perform mathematical calculations', isCorrect: false),
        AnswerChoice(
            text: 'B. To manipulate strings efficiently', isCorrect: true),
        AnswerChoice(
            text: 'C. To iterate over elements in a collection',
            isCorrect: false),
        AnswerChoice(
            text: 'D. To manage file input and output operations',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      questionText:
          'Which of the following access modifiers restricts access to members within the same assembly?',
      answerChoices: [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'B. To execute a block of code repeatedly', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To define a collection of key-value pairs',
            isCorrect: false),
        AnswerChoice(
            text: 'B. To represent a collection that can be enumerated',
            isCorrect: true),
        AnswerChoice(text: 'C. To manage concurrency', isCorrect: false),
        AnswerChoice(
            text: 'D. To define a sequence of characters', isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText: 'What is the output of the following C# code?'
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To define asynchronous methods and wait for their completion',
            isCorrect: true),
        AnswerChoice(
            text: 'B. To perform mathematical calculations', isCorrect: false),
  ...
  'C#_Level 4': [
    QuizQuestion(
      questionText:
          'Which collection type in C# does not allow duplicate elements?',
      answerChoices: [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To define a synchronization context for concurrent access to shared resources',
            isCorrect: true),
        AnswerChoice(
            text: 'B. To iterate over elements in a collection',
            isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To return a value from a method', isCorrect: false),
        AnswerChoice(
            text: 'B. To halt the execution of a method', isCorrect: false),
        AnswerChoice(
            text: 'C. To return each element of an enumerable one at a time',
            isCorrect: true),
        AnswerChoice(
            text: 'D. To execute a block of code repeatedly', isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText:
          'Which LINQ operator is used to filter elements based on a condition?',
      answerChoices: [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To represent a method that takes no arguments and returns a value',
            isCorrect: false),
        AnswerChoice(
            text:
        ...
        AnswerChoice(
            text:
                'C. To represent a method that takes no arguments and does not return a value',
            isCorrect: true),
        AnswerChoice(
            text:
                'D. To represent a method that takes multiple arguments and returns a value',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'B. Delegates cannot be used to call static methods',
            isCorrect: false),
        AnswerChoice(
            text: 'C. Delegates can hold references to one or more methods',
            isCorrect: true),
        AnswerChoice(
            text: 'D. Delegates are defined using the delegate keyword',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To specify that a parameter is passed by reference',
            isCorrect: true),
        AnswerChoice(
            text: 'B. To specify that a parameter is optional',
            isCorrect: false),
  ...
  'C#_Level 5': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. To define an asynchronous method', isCorrect: true),
        AnswerChoice(
            text: 'B. To specify that a method does not return a value',
            isCorrect: false),
        AnswerChoice(
            text: 'C. To define an extension method', isCorrect: false),
        AnswerChoice(
            text: 'D. To specify that a class cannot be instantiated',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            ...
            isCorrect: false),
        AnswerChoice(
            text: 'B. To allocate memory for an object', isCorrect: false),
        AnswerChoice(
            text: 'C. To declare a variable of an unknown type at compile time',
            isCorrect: true),
        AnswerChoice(
            text:
                'D. To define a method that can be accessed without an instance of the class',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Exits the current method and returns a value',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. Halts the execution of the current iteration and continues with the next iteration',
            isCorrect: false),
        AnswerChoice(
            text: 'C. Returns each element of an enumerable one at a time',
            isCorrect: true),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Current date and time in "yyyy-MM-dd HH:mm:ss" format',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Current date and time in "dd-MM-yyyy HH:mm:ss" format',
            isCorrect: false),
        AnswerChoice(text: 'C. Compilation Error', isCorrect: false),
        AnswerChoice(
            text: 'D. Current date and time in "MM-dd-yyyy HH:mm:ss" format',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To specify that a block of code should be executed atomically',
            isCorrect: false),
        AnswerChoice(
            text: 'B. To explicitly enable arithmetic overflow checking',
            isCorrect: true),
        AnswerChoice(text: 'C. To handle exceptions', isCorrect: false),
  ...
  'Dart_Level 1': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'C. Both compiled and interpreted', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'D. Asynchronous programming support', isCorrect: false),
      ],
    ),
    QuizQuestion(
  ...
  'Dart_Level 2': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'B. The function returns an integer', isCorrect: false),
        AnswerChoice(
            text: 'C. The function returns a string', isCorrect: false),
        AnswerChoice(
            text: 'D. The function returns a boolean value', isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText: 'What is the output of the following Dart code?'
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. It is the entry point of a Dart program',
            isCorrect: true),
        AnswerChoice(
            text: 'B. It is used to define global variables', isCorrect: false),
        AnswerChoice(
            text: 'C. It is used to declare classes', isCorrect: false),
        AnswerChoice(
            text: 'D. It is used to import external libraries',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'C. List<int> myList = [1, 2, 3];', isCorrect: false),
  ...
  'Dart_Level 3': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'C. Prints the numbers from 1 to 5', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Sorts the list of fruits in alphabetical order',
            isCorrect: true),
        AnswerChoice(text: 'B. Reverses the list of fruits', isCorrect: false),
        AnswerChoice(
            text: 'C. Prints the length of the list', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the square of each number in the list',
            isCorrect: true),
        AnswerChoice(text: 'B. Reverses the list of numbers', isCorrect: false),
        AnswerChoice(
            text: 'C. Finds the maximum value in the list', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the sum of all numbers in the list',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Computes the average of all numbers in the list',
            isCorrect: false),
        AnswerChoice(
            text: 'C. Finds the maximum value in the list', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
  ...
  'Dart_Level 4': [
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Converts binary string to decimal integer',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Converts decimal integer to binary string',
            isCorrect: false),
        AnswerChoice(
            text: 'C. Computes the factorial of a number', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the nth Fibonacci number', isCorrect: true),
        AnswerChoice(
            text: 'B. Computes the factorial of a number', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the greatest common divisor of two numbers',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Computes the least common multiple of two numbers',
            isCorrect: false),
        AnswerChoice(text: 'C. Reverses a list', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the sum of squares of first n natural numbers',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Computes the factorial of a number', isCorrect: false),
        AnswerChoice(
            text: 'C. Computes the nth Fibonacci number', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'B. Converts a string to uppercase', isCorrect: false),
        AnswerChoice(
            text: 'C. Converts a string to lowercase', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
  ...
  'Dart_Level 5': [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Generates the first n Fibonacci numbers',
            isCorrect: true),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the factorial of a number recursively',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Computes the Fibonacci sequence', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Computes the power of a number', isCorrect: true),
        AnswerChoice(
            text: 'B. Computes the square root of a number', isCorrect: false),
        AnswerChoice(
            text: 'C. Computes the factorial of a number', isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. [1, 1, 2, 3, 3, 4, 5, 5, 5, 6, 9]', isCorrect: true),
        AnswerChoice(
            text: 'B. [9, 6, 5, 5, 5, 4, 3, 3, 2, 1, 1]', isCorrect: false),
    ...
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'B. ["banana", "apple", "cherry"]', isCorrect: false),
        AnswerChoice(text: 'C. Compilation Error', isCorrect: false),
        AnswerChoice(text: 'D. Runtime Error', isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Sorts the list using bubble sort algorithm',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Sorts the list using merge sort algorithm',
            isCorrect: false),
        AnswerChoice(
            text: 'C. Sorts the list using quick sort algorithm',
            isCorrect: false),
        AnswerChoice(text: 'D. Compilation Error', isCorrect: false),
      ],
    ),
  ...
  'PHP_Level 1': [
    QuizQuestion(
      ...
      answerChoices: [
        ...
        AnswerChoice(
            text: 'D. Professional Hypertext Programming', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      questionText:
          'What is the correct way to comment a single line of PHP code?',
      answerChoices: [
    ...
    QuizQuestion(
      questionText:
          'Which variable scope in PHP is accessible from any function, class, or file?',
      answerChoices: [
    ...
    QuizQuestion(
      questionText:
          'Which PHP superglobal variable stores form data after submitting an HTML form with method="post"?',
      answerChoices: [
  ...
  'PHP_Level 2': [
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Returns the number of lines in a string',
            isCorrect: false),
        AnswerChoice(
            text: 'B. Returns the length of a string', isCorrect: true),
        AnswerChoice(
            text:
                'C. Returns the position of the first occurrence of a substring',
            isCorrect: false),
        AnswerChoice(
            text: 'D. Converts a string to uppercase', isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText:
          'Which PHP loop is used to execute a block of code a specified number of times?',
      answerChoices: [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Splits a string into an array based on a delimiter',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Combines array elements into a string', isCorrect: false),
        AnswerChoice(
            text: 'C. Reverses the characters in a string', isCorrect: false),
        AnswerChoice(
            text: 'D. Searches for a substring within a string',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText:
          'Which PHP function is used to redirect the user to a different URL?',
      answerChoices: [
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Checks if a variable has been initialized',
            isCorrect: true),
        AnswerChoice(
            text: 'B. Checks if a variable is empty', isCorrect: false),
        AnswerChoice(text: 'C. Checks if a variable is null', isCorrect: false),
        AnswerChoice(
            text: 'D. Checks if a variable is defined', isCorrect: false),
      ],
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text: 'A. Returns the number of characters in a string',
            isCorrect: false),
        AnswerChoice(
            text: 'B. Returns the number of elements in an array or object',
            isCorrect: true),
        AnswerChoice(
            text: 'C. Returns the number of words in a string',
            isCorrect: false),
        AnswerChoice(
            text: 'D. Returns the number of lines in a file', isCorrect: false),
      ],
    ),
    QuizQuestion(
  ...
  'PHP_Level 3': [
    QuizQuestion(
      questionText:
          'Given an array \$numbers = [3, 7, 2, 8, 4], what is the output of the following PHP code?'
          '\n\n<?php'
    ...
    QuizQuestion(
      questionText:
          'Given the array \$colors = ["red", "green", "blue", "yellow"], what is the output of the following PHP code?'
          '\n\n<?php'
          '\nshuffle(\$colors);'
          '\necho \$colors[0];'
          '\n?>',
      answerChoices: [
        AnswerChoice(
            text: 'A. The first element of the shuffled array',
            isCorrect: true),
    ...
    QuizQuestion(
      questionText:
          'Given the array \$numbers = [2, 4, 6, 8, 10], what is the output of the following PHP code?'
          '\n\n<?php'
          '\nfunction double(\$num) {'
          '\nreturn \$num * 2;'
          '\n}'
  ...
  'PHP_Level 5': [
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To avoid naming conflicts between classes, functions, and constants',
            isCorrect: true),
        AnswerChoice(
            text: 'B. To optimize memory usage in PHP applications',
            isCorrect: false),
        AnswerChoice(
            text: 'C. To enable cross-origin resource sharing (CORS)',
            isCorrect: false),
        AnswerChoice(
            text: 'D. To encrypt sensitive data transmitted over the network',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. Traits are a mechanism for code reuse in single inheritance languages like PHP, allowing the composition of methods from multiple sources into a single class',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. Traits are used for type hinting in PHP, ensuring that only specific types of values are accepted as function arguments',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. Traits are used to define abstract classes in PHP, providing a blueprint for creating objects',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. Traits are used for error handling in PHP, allowing developers to catch and handle exceptions gracefully',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. Abstract classes can contain both abstract and concrete methods, while interfaces can only contain method signatures',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. Abstract classes can be instantiated directly, while interfaces cannot be instantiated and must be implemented by concrete classes',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. Abstract classes can have visibility modifiers on their methods, while interfaces cannot have any method visibility modifiers',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. Abstract classes can provide partial implementation of methods, while interfaces provide a contract that concrete classes must adhere to without specifying any implementation',
            isCorrect: true),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. Late static binding allows static methods to be overridden by child classes at runtime',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. Late static binding refers to the process of dynamically binding static variables to values during program execution',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. Late static binding allows access to the current class name within a static method using the self keyword',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. Late static binding enables the creation of anonymous classes in PHP',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To define a method that will be called when an object is treated as a function',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. To define a method that will be called when an object is cloned using the clone keyword',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. To define a method that will be called when an object is serialized using the serialize() function',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. To define a method that will be called when an object is converted to a string using the strval() function',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. To define how an object should be represented as a string when directly output or converted to a string using echo or print',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. To define how an object should be compared with other objects using the equality operator (==)',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. To define how an object should be serialized into a string representation using the serialize() function',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. To define how an object should be cloned using the clone keyword',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. Anonymous classes are classes without a named identifier, often used for one-off object instantiation and implementation of interfaces',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. Anonymous classes are classes that cannot have any properties, only methods',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. Anonymous classes are classes that cannot be extended or implemented by other classes',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. Anonymous classes are classes that do not support method overloading or overriding',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      questionText:
          'What is the purpose of the finally block in a PHP try-catch-finally statement?',
      answerChoices: [
        AnswerChoice(
            text:
                'A. The finally block is executed regardless of whether an exception is thrown or caught, allowing for cleanup operations such as closing database connections or releasing resources',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. The finally block is executed only if an exception is thrown, allowing for custom error handling logic',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. The finally block is executed only if an exception is caught, allowing for graceful error recovery',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. The finally block is executed before the try block, allowing for pre-execution setup operations',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. The yield keyword is used to create a generator function, allowing for lazy evaluation of large data sets',
            isCorrect: true),
        AnswerChoice(
            text:
                'B. The yield keyword is used to interrupt the execution of a loop and return control to the calling function',
            isCorrect: false),
        AnswerChoice(
            text:
                'C. The yield keyword is used to concatenate strings within a loop without creating intermediate variables',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. The yield keyword is used to throw an exception and halt the execution of a function',
            isCorrect: false),
      ],
    ),
    QuizQuestion(
      ...
      answerChoices: [
        AnswerChoice(
            text:
                'A. The Generator class provides an interface for defining custom generators in PHP',
            isCorrect: false),
        AnswerChoice(
            text:
                'B. The Generator class is a built-in class used to create iterator objects with the yield keyword',
            isCorrect: true),
        AnswerChoice(
            text:
                'C. The Generator class provides utility methods for performing operations on arrays in PHP',
            isCorrect: false),
        AnswerChoice(
            text:
                'D. The Generator class is used to manage session data and maintain user state in PHP web applications',
            isCorrect: false),
      ],
    ),
  ],
