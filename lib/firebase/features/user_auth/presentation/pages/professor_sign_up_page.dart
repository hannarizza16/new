...
class ProfessorSignUpPage extends StatefulWidget {
  ...
  @override
  State<ProfessorSignUpPage> createState() => _ProfessorSignUpPage();
}

class _ProfessorSignUpPage extends State<ProfessorSignUpPage> {
  final FirebaseAuthService _auth = FirebaseAuthService();

  final TextEditingController _professorNumberController =
  ...
  @override
  void dispose() {
    _professorNumberController.dispose();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FormContainerWidget(
                          controller: _professorNumberController,
                          labelText: "Professor Number",
                          hintText: "Professor Number",
                          isPasswordField: false,
                        ),
                        const SizedBox(
                          height: 10,
  ...
  void _signUp() async {
    ...
    String professorNumber = _professorNumberController.text;
    ...
    if (initial.isNotEmpty &&
        (initial.length != 1 || !initial.contains(RegExp(r'[a-zA-Z]')))) {
      setState(() {
        isSigningUp = false;
      });
  ...
  Future<void> saveUserDataToFirestore(String studentID, String email) async {
    ...
    await collRef.add({
      ...
      'professorNumber': _professorNumberController.text,
